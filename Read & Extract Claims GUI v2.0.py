...
class Processor(Frame):
    ...
    def initUI(self):
        ...
        self.label0 = Label(self, text="Instructions:"
                                        "\n 1. Create new folder, any name works" 
                                        "\n 2. Place pdf package and provided vba inside the folder"
                                        "\n 3. Provide the respective fields below and click submit"
                                , font="Helvetica 8 bold").grid(row=1, columnspan=3, column=1, padx=2, pady=10)

        self.label1 = Label(self, text="Directory of folder that hosts PDF Package & VBA sheet",
                            font="Helvetica 8 bold italic").grid(row=2, column=1, padx=5, pady=5)

        self.label2 = Label(self, text="Name of PDF package \n WARNING: Pack should contain ONLY UB04-type claims",
                            font="Helvetica 8 bold italic").grid(row=3, column=1, padx=5, pady=5)

        self.label3 = Label(self, text="Name of VBA Tracking Sheet",
                            font="Helvetica 8 bold italic").grid(row=4, column=1, padx=5, pady=5)

        self.entry1 = Entry(self, width=40)
        self.entry2 = Entry(self, width=40)
        self.entry3 = Entry(self, width=40)

        self.entry1.grid(row=2, column=2, padx=5, pady=2)
        self.entry2.grid(row=3, column=2, padx=5, pady=2)
        self.entry3.grid(row=4, column=2, padx=5, pady=2)
